...
/**
 * Builds the LLM classification prompt from a {@link dev.callisto.model.BugRecord}.
 *
 * <p>Sanitizes newlines in the exception message to prevent prompt structure injection.
 * Annotates stack frames with {@code [INTERNAL]} / {@code [EXTERNAL]} labels when
 * package-source information is available.
 */
public class PromptBuilder {
    ...
    public static String buildPrompt(BugRecord record) {
        ...
        // Sanitize newlines in exception message — prevents prompt structure injection
