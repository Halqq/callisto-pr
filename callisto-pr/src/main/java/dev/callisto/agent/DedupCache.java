...
/**
 * In-memory deduplication cache with configurable TTL.
 *
 * D-09: default window of 60 seconds
 * AGENT-03: same fingerprint ID is not reported twice within the window
 *
 * Thread-safe: ConcurrentHashMap with atomic operations.
 * On-access expiry: expired entries are cleaned up at verification time.
 *
 * Java 11: uses static inner class instead of record (Java 16+).
 */
